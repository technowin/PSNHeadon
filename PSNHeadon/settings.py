"""
Django settings for PSNHeadon project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'psn_headon_db',      # Replace with your database name
        'USER': 'root',      # Replace with your database user
        'PASSWORD': 'Mysql_7319',  # Replace with your database password
        'HOST': '13.202.30.119',       # IP FOR TEST
...
# SESSION_FILE_PATH=r"D:\PYTHON PROJECTS\PSNHeadon"
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            # 'filename': os.path.join(BASE_DIR, '/home/ubuntu/PSNHeadon Logs', 'django.log'),  
        },
    },
    'loggers': {
        'django': {
...
WSGI_APPLICATION = 'PSNHeadon.wsgi.application'
