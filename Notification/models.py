...
class user_notification_log(models.Model):
    ...
    emp_id = models.ForeignKey(sc_employee_master, on_delete=models.CASCADE,related_name='employee_notif_id',blank=True, null=True,db_column='emp_id')
    ...
    updated_at = models.DateTimeField(null=True,blank=True,auto_now_add=True)
    updated_by = models.ForeignKey(CustomUser, on_delete=models.CASCADE,related_name='user_noti_updated_by',blank=True, null=True,db_column='updated_by')
    class Meta:
...
class slot_notification_log(models.Model):
    ...
    updated_at = models.DateTimeField(null=True,blank=True,auto_now_add=True)
    updated_by = models.ForeignKey(CustomUser, on_delete=models.CASCADE,related_name='slot_noti_updated_by',blank=True, null=True,db_column='updated_by')
    class Meta:
